...
var runReport = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, data, error, latestPools, sorted;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                console.log("Found ".concat(data.length, " records. Showing top scored pools from latest scan:\n"));
                latestPools = new Map();
                ...
                sorted = Array.from(latestPools.values()).sort(function (a, b) { return b.score - a.score; });
                // Print Table
                console.table(sorted.map(function (p) { return ({
                    Name: p.name,
