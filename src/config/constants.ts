...
export const BOT_CONFIG = {
    ...
    TARGET_ALLOCATIONS: [0.15, 0.12, 0.10, 0.10, 0.10, 0.10, 0.08, 0.08, 0.07, 0.05, 0.03, 0.02] as const,
 ...
 */
export const ENABLE_PEPF = process.env.ENABLE_PEPF !== 'false'; // Default: enabled

/**
 * PEPF Configuration with justifications
 */
export const PEPF_CONFIG = {
    // ═══════════════════════════════════════════════════════════════════════════
