...
var scanPools = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, pools, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                logger_1.default.info('Scanning DLMM pools from Meteora API...');
                return [4 /*yield*/, axios_1.default.get(METEORA_API_URL)];
            case 1:
                response = _a.sent();
                if (response.status !== 200) {
                    throw new Error("Failed to fetch pools: ".concat(response.statusText));
                }
                pools = response.data;
                logger_1.default.info("Fetched ".concat(pools.length, " pools."));
                return [2 /*return*/, pools];
            case 2:
                error_1 = _a.sent();
                logger_1.default.error('Error scanning pools:', error_1);
                return [2 /*return*/, []];
